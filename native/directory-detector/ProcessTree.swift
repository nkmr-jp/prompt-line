...
extension DirectoryDetector {
    ...
    /// Note: tmux detection is now handled by MultiplexerDetector as a last resort
    ...
    // Note: Old getTmuxTerminalDirectory() removed - tmux detection now handled by MultiplexerDetector

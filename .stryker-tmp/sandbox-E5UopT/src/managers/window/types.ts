...
import type { AppInfo, DirectoryInfo, FileSearchSettings, StartupPosition, WindowData, SpaceInfo } from '../../types';
 ...
 */
export type { AppInfo, DirectoryInfo, FileSearchSettings, WindowData, SpaceInfo };
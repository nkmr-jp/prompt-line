...
## [0.29.4](https://github.com/nkmr-jp/prompt-line/compare/prompt-line-v0.29.3...prompt-line-v0.29.4) (2026-04-11)


### Features

* **plugins:** plugin system v2 with GitHub repo-based install and `@ref` support ([#303](https://github.com/nkmr-jp/prompt-line/issues/303)) ([3bf5265](https://github.com/nkmr-jp/prompt-line/commit/3bf5265))
...
* **plugins:** v2 plugin and settings format with hot reload ([#330](https://github.com/nkmr-jp/prompt-line/issues/330)) ([f988848](https://github.com/nkmr-jp/prompt-line/commit/f988848))

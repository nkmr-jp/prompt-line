...
symbolSearch:
  respectGitignore: ${formatValue(ss.respectGitignore)}           # Respect .gitignore files
...
`;
  ...
  return `${topSections}
# ============================================================================
# PLUGIN SETTINGS (refs: \`prompt-line-plugin help\`)
# ============================================================================
# You can add your own plugins. refs: \`prompt-line-plugin help\`

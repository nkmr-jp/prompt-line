...
interface LoadedPlugin {
  pluginPath: string;  // relative path (e.g., "plugins/claude/agent-skills/commands")
  type: PluginType;
 ...
 *   e.g., ~/.prompt-line/plugins/plugins/claude/agent-skills/commands.yml
 *
...
class PluginLoader {
   ...
   * e.g., "plugins/claude/agent-skills/commands" → 'agent-skills'
   */
   ...
   * Input:  "plugins/claude/agent-skills/commands"
   * Output: "/home/user/.prompt-line/plugins/plugins/claude/agent-skills/commands"
   */
